...
test('getAddressesUtxo', (done) => {
  explorer.getAddressesUtxo(['FHQvhgDut1rn1nvQRZ3z9QgMEVMavRo2Tu', 'FFrfhbjbqgVNs6WYatav2wnb7LrCcmyDmm']).then((utxos) => {
    ...
    for (const utx of utxos) {
      if (utx.txid === '96ff94c61ab95312d8ae483f91ff28f49de4e2d2371ff182168ebfbdc5f54faf' || utx.txid === '714a1eb73a6e0ee9ec6b73b85f852e3ed4bd68ddf2e0e1f4bcef12ca36ba506c') { match = true }
    }
